...
#['#0035d4', '#f2f3f5']
PLAYER_COLOR_BLUE_HEX = "#FFFFFF"
PLAYER_COLOR_BLUE = Color.from_hex_string(PLAYER_COLOR_BLUE_HEX)
PLAYER_COLOR_WHITE_HEX = "#fc0303"
PLAYER_COLOR_WHITE = Color.from_hex_string(PLAYER_COLOR_WHITE_HEX)

TEAM_1_COLOR_HEX = "#fc0303"
TEAM_1_COLOR = Color.from_hex_string(TEAM_1_COLOR_HEX)

TEAM_2_COLOR_HEX = "#035afc"
TEAM_2_COLOR = Color.from_hex_string(TEAM_2_COLOR_HEX)
